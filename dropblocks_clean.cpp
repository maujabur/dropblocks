...
int main() {
    printf("=== DROPBLOCKS CLEAN VERSION ===\n");
    printf("VERSION: 7.4 - Clean Working Version\n");
    printf("Using EXACT same approach as test_window that works\n");
    fflush(stdout);
    ...
    printf("DEBUG: Clean version completed successfully!\n");
    fflush(stdout);
